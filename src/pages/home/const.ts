...
export const SetRoomsConnection = (data: Props) => {
  ...
  socket.on(CREATE_SUCCESS_SOCKET, (id: string) => accessPermitted(id, navigate, setIsLoading))
  socket.on(CREATE_ERROR_SOCKET, (e: string) => accessUnPermitted(e, setIsLoading))
